...
class LLMQAParticipantModel(ParticipantModel):
    ...
    def query(self, state, debug=False):
        logger.debug(f"Run generate answer")
        ...
        answer, facts_used = self.qa_model.ask_question(input_question=question, context=context, context_suffix=context_suffix)  # TODO
