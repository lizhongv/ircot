...
class LLMQAModel:
    def __init__(self, prompt_file="", prompt_reader_args=None, regex_extract=None, add_context=True, gen_model="gpt3", **kwargs):
        # CoT prompt
        if prompt_file:
        ...
        # Gnerator
        if gen_model == "gpt3":
            self.generator = GPT3Generator(**kwargs)  # TODO
    ...
    def ask_question(self, input_question, context, context_suffix=""):
        ...
        logger.debug(f"Generate answer for question: {LYELLOW}{question_prompt}{RESET}")
